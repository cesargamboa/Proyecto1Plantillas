...
${OBJECTDIR}/EmpleadoBase.o: EmpleadoBase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EmpleadoBase.o EmpleadoBase.cpp

${OBJECTDIR}/EmpleadoPlanilla.o: EmpleadoPlanilla.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EmpleadoPlanilla.o EmpleadoPlanilla.cpp

${OBJECTDIR}/EmpleadoServiciosProfesionales.o: EmpleadoServiciosProfesionales.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EmpleadoServiciosProfesionales.o EmpleadoServiciosProfesionales.cpp
